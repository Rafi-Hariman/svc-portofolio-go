...
func (db *oraclePortofolioRepository) GetAll(param map[string]interface{}) (response []valueobject.Portofolio, err error) {
...
func (db *oraclePortofolioRepository) GetOne(param map[string]interface{}) (response valueobject.Portofolio, err error) {
	builder := database.New(ORACLE, ORACLE_TABLE, SELECT)
...
func (db *oraclePortofolioRepository) Store(column []string, data []interface{}) (builder database.QueryConfig, err error) {
...
func (db *oraclePortofolioRepository) Update(param map[string]interface{}, data map[string]interface{}) (builder database.QueryConfig, err error) {
...
func (db *oraclePortofolioRepository) Delete(param map[string]interface{}) (builder database.QueryConfig, err error) {
