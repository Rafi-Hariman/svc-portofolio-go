...
func (handler *HttpPortofolioHandler) GetAll(ctx *gin.Context) {
	...
	response, err := handler.portofolioUsecase.GetAll(param)
	...
	count, err := handler.portofolioUsecase.Count(param)
...
func (handler *HttpPortofolioHandler) GetByUUID(ctx *gin.Context) {
	var param = map[string]interface{}{
		"AND": map[string]interface{}{
			"uuid": ctx.Param("uuid"),
		},
	...
	response, err := handler.portofolioUsecase.GetOne(param)
...
func (handler *HttpPortofolioHandler) Store(ctx *gin.Context) {
	var payload valueobject.PortofolioPayloadInsert
	...
	feedback, err := handler.portofolioUsecase.Store(payload)
...
func (handler *HttpPortofolioHandler) Update(ctx *gin.Context) {
	var payload valueobject.PortofolioPayloadUpdate
	...
	err = handler.portofolioUsecase.Update(payload)
...
func (handler *HttpPortofolioHandler) Delete(ctx *gin.Context) {
	var payload valueobject.PortofolioPayloadDelete
	...
	err = handler.portofolioUsecase.Delete(payload)
