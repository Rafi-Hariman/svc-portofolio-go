...
func (db *oracleAuthRepository) GetAll(param map[string]interface{}) (response []valueobject.Auth, err error) {
...
func (db *oracleAuthRepository) GetOne(param map[string]interface{}) (response valueobject.Auth, err error) {
	builder := database.New(ORACLE, ORACLE_TABLE, SELECT)
...
func (db *oracleAuthRepository) Store(column []string, data []interface{}) (builder database.QueryConfig, err error) {
...
func (db *oracleAuthRepository) Update(param map[string]interface{}, data map[string]interface{}) (builder database.QueryConfig, err error) {
...
func (db *oracleAuthRepository) Delete(param map[string]interface{}) (builder database.QueryConfig, err error) {
